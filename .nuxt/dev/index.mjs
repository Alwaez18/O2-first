...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/devalue/index.js';
import destr from 'file:///Users/o2/projectYarik/O2maket2/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/unenv/runtime/fetch/index.mjs';
...
import { consola } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/vue/index.mjs';
import { hash } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/o2/projectYarik/O2maket2/node_modules/@unhead/shared/dist/index.mjs';
...
const _0I1uEF1O1C = (function(nitro) {
...
const _lazy_CiM338 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_CiM338, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CiM338, lazy: true, middleware: false, method: undefined }
];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/o2/projectYarik/O2maket2","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/o2/projectYarik/O2maket2/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/o2/projectYarik/O2maket2/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/o2/projectYarik/O2maket2/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/o2/projectYarik/O2maket2/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
